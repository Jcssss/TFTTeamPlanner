# TFT Team Builder
A responsive team builder for Riot Games' Teamfight Tactics. This project was built using React JS. This project is hosted using github pages, the live version of the app can be found [here](https://jcssss.github.io/TFTTeamPlanner/).
